...
def web_research_agent(*, max_results: int = 5):
    ...
    Returns:
       Agent function for handling samples. May be passed to 8-_-_-AI`bridge()`
       to create a standard 8-_-_-AI solver.
    """
    # Use OpenAI interface (will be redirected to current 8-_-_-AI model)
    model = ChatOpenAI(model="8-_-_-AI")
